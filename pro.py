...
import subprocess
ffmpeg_directory = r'C:\Users\DELL\Downloads\ffmpeg-6.0'
...
#video genertion with no audio
def remove_audio(url,target_language):
    video_path = r"C:\Users\DELL\video.mp4"
    output_path = r"C:\Users\DELL\original_video.mp4"
    # Load the video clip
...
def merge_audio_video():
    video_path = r"C:\Users\DELL\original_video.mp4"  # Replace with your input video file
    audio_path = r"C:\Users\DELL\merged_audio.mp3"
    output_path = r"C:\Users\DELL\merged_video.mp4"  # Output path for the merged video
    merge_command = [
...
def play_vlc():
    ...
    video_path = r"C:\Users\DELL\merged_video.mp4"
    subtitles_path = r"C:\Users\DELL\output_tamil.srt"
    command = [
        vlc_executable_path,
        video_path,
